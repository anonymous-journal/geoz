...
See the file ([LICENSE](https://github.com/anonymous-journal/geoz/blob/main/LICENSE)) for information on the terms & conditions for usage, and a DISCLAIMER OF ALL WARRANTIES.
